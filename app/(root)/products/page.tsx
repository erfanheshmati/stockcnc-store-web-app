...
import SortSwitch from "../archiv/[slug]/sort-switch";
import { SortProvider } from "@/contexts/sort-popup-context";
import DialogSort from "../archiv/[slug]/dialog-sort";
...
export async function generateMetadata() {
  ...
  return {
    title: `${info.archiveProductSeoTitle} - ${info.title}`,
...
export default async function ProductsPage({
  ...
  const res2 = await fetch(`${BASE_URL}/product`, {
    method: "POST",
  });
