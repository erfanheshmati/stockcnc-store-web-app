...
export default function AdvancedFilter({ className }: { className: string }) {
  ...
  return (
    <div
      className={cn(
        "flex w-[90%] md:w-[740px] lg:w-[995px] sm:h-[75px] md:h-[92px] bg-white shadow-lg rounded-l-2xl rounded-br-2xl relative",
        className
      )}
    >
      {/* Sloped Label Background */}
      <div
        className="absolute -top-[40px] md:-top-[55px] right-2 sm:right-4 h-[40px] md:h-[60px] w-[190px] md:w-[290px] rounded-tr-2xl bg-[#D7DDE938]"
        style={{
      ...
      {/* Sloped Label */}
      <div
        className="absolute -top-[35px] md:-top-[50px] h-[40px] md:h-[60px] w-[185px] md:w-[280px] rounded-tr-2xl bg-white flex items-center px-4 md:px-10"
        style={{
      ...
      <form
        ...
        className="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-4 md:px-6 py-4 sm:py-0 lg:px-10"
      >
        {/* Filter 1: نوع دستگاه */}
        <div className="relative">
          ...
          {/* Custom Arrow Icon */}
          <div className="flex items-center gap-1 absolute top-1/2 left-4 sm:left-2 md:left-4 transform -translate-y-1/2 pointer-events-none">
            <span className="sm:hidden lg:block text-[#8C9EB9] text-[12px]">
              انتخاب کنید
            </span>
        ...
        <button
          className="flex items-center justify-center h-[45px] rounded-xl sm:rounded-none bg-primary/90 sm:bg-transparent hover:bg-primary sm:hover:bg-transparent"
          type="submit"
        >
          <svg
            width="62"
          ...
          >
            <path
              ...
              className="fill-white sm:fill-[#8898af] group-hover:fill-primary transition-all duration-300 ease-in-out"
            />
          </svg>
        </button>
      </form>
