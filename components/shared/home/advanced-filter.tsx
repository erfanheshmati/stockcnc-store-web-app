  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="flex items-center justify-between w-full px-4 md:px-6 lg:px-10 overflow-hidden"
      >
        {/* Filter 1: نوع دستگاه */}
        <div className="relative">
          <select
            ...
            className="flex px-2 sm:px-4 focus:outline-none text-[12px] md:text-[15px] min-w-[90px] sm:min-w-[120px] md:min-w-[190px] lg:min-w-[220px] h-[45px] md:h-[55px] rounded-2xl md:rounded-full bg-[#F0F3F8] text-[#52637C] font-semibold cursor-pointer appearance-none"
          >
          ...
          {/* Custom Arrow Icon */}
          <div className="flex items-center gap-2 absolute top-1/2 left-2 md:left-4 transform -translate-y-1/2 pointer-events-none">
            <span className="hidden md:block text-[#8C9EB9] text-[12px]">
              انتخاب کنید
            </span>
        ...
        <div className="relative">
          <select
            ...
            className="flex px-2 sm:px-4 focus:outline-none text-[12px] md:text-[15px] min-w-[90px] sm:min-w-[120px] md:min-w-[190px] lg:min-w-[220px] h-[45px] md:h-[55px] rounded-2xl md:rounded-full bg-[#F0F3F8] text-[#52637C] font-semibold cursor-pointer appearance-none disabled:bg-gray-200"
          >
        ...
        <button
          className="min-w-[62px] disabled:opacity-50"
          type="submit"
          disabled={
